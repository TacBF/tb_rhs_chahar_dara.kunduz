class TacBF
{
        class Supply
        {
                ...
                class CargoCollections
                {
                        class statics_west {
                                transportClear = 1;
                                cargo[] = {{"RHS_M2StaticMG_D", 2, 6}, {"RHS_M252_D", 2, 12}, {"RHS_TOW_TriPod_D", 1, 2}};
                        };
                        class statics_east {
                                transportClear = 1;
                                cargo[] = {{"RHS_TOW_TriPod_D", 2, 6}, {"rhsgref_ins_SPG9", 1, 2}, {"TB_Box_East_Mines_F", 5, 0}};
                        };
